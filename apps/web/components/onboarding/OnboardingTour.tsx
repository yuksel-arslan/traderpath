...
export function OnboardingTour({
  ...
  useEffect(() => {
    (window as unknown as Record<string, any>)[`startTour_${tourId}`] = startTour;
    return () => {
      delete (window as unknown as Record<string, any>)[`startTour_${tourId}`];
    };
  }, [tourId, startTour]);
...
export function TourTriggerButton({
  ...
  const handleClick = () => {
    const startTour = (window as unknown as Record<string, any>)[`startTour_${tourId}`];
    if (startTour) {

...
import { Search, ChevronDown, Star, TrendingUp, Clock, X } from 'lucide-react';
    ...
    <div className="space-y-4">
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        <button
          ...
          className="w-full flex items-center justify-between gap-3 px-4 py-3 bg-background border-2 border-border rounded-xl hover:border-primary/50 transition-colors"
        >
          {selectedCoin ? (
        ...
        {isOpen && (
          <div className="absolute top-full left-0 right-0 mt-2 bg-card border rounded-xl shadow-xl z-50 overflow-hidden">
            ...
            <div className="max-h-80 overflow-y-auto">
              ...
              <div className="p-2">
                {!search && (
                  <div className="flex items-center gap-2 text-xs text-muted-foreground px-2 py-1 mb-1">

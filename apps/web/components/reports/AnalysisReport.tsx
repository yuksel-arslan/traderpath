...
// ===========================================
// TradePath Professional Analysis Report
// ===========================================
  ...
  <div class="page">
    <div class="header">
      <div class="brand">
        ...
        <div>
          <div class="brand-name"><span class="brand-trade">Trade</span><span class="brand-path">Path</span></div>
        </div>
      </div>
    ...
    <div class="footer">
      <span><span class="brand-trade">Trade</span><span class="brand-path">Path</span> | ID: ${data.analysisId?.slice(-10) || '-'}</span>
...
function generatePage3(data: AnalysisReportData): string {
  ...
  <div class="page">
    ...
    <div class="footer">
      <span>(c) ${new Date().getFullYear()} TradePath | ID: ${data.analysisId?.slice(-10) || '-'}</span>
...
export async function generateAnalysisReport(data: AnalysisReportData, captureChart: boolean = true): Promise<PdfResult | void> {
  ...
  const fileName = `TradePath_${data.symbol}${tradeType ? `_${tradeType}` : ''}_${new Date().toISOString().split('T')[0]}.pdf`;

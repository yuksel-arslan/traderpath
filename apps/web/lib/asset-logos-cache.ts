...
const FALLBACK_STOCK_LOGOS: Record<string, AssetLogoInfo> = {
  ...
  IWM: { logoUrl: 'https://logo.clearbit.com/ishares.com', color: '#000000', name: 'iShares Russell 2000' },
  VTI: { logoUrl: 'https://logo.clearbit.com/vanguard.com', color: '#8B2332', name: 'Vanguard Total Stock' },
  // Sector ETFs
  XLF: { logoUrl: 'https://logo.clearbit.com/ssga.com', color: '#00529B', name: 'Financial Select SPDR' },
  XLK: { logoUrl: 'https://logo.clearbit.com/ssga.com', color: '#00529B', name: 'Technology Select SPDR' },
  XLE: { logoUrl: 'https://logo.clearbit.com/ssga.com', color: '#00529B', name: 'Energy Select SPDR' },
  XLV: { logoUrl: 'https://logo.clearbit.com/ssga.com', color: '#00529B', name: 'Health Care Select SPDR' },
  XLI: { logoUrl: 'https://logo.clearbit.com/ssga.com', color: '#00529B', name: 'Industrial Select SPDR' },
  // Tech Giants
  ...
  GOOG: { logoUrl: 'https://logo.clearbit.com/google.com', color: '#4285F4', name: 'Alphabet' },
  AMZN: { logoUrl: 'https://logo.clearbit.com/amazon.com', color: '#FF9900', name: 'Amazon' },
  META: { logoUrl: 'https://logo.clearbit.com/meta.com', color: '#0668E1', name: 'Meta Platforms' },
  ...
  INTC: { logoUrl: 'https://logo.clearbit.com/intel.com', color: '#0071C5', name: 'Intel' },
  CRM: { logoUrl: 'https://logo.clearbit.com/salesforce.com', color: '#00A1E0', name: 'Salesforce' },
  ORCL: { logoUrl: 'https://logo.clearbit.com/oracle.com', color: '#F80000', name: 'Oracle' },
  ADBE: { logoUrl: 'https://logo.clearbit.com/adobe.com', color: '#FF0000', name: 'Adobe' },
  NFLX: { logoUrl: 'https://logo.clearbit.com/netflix.com', color: '#E50914', name: 'Netflix' },
  // Finance
  JPM: { logoUrl: 'https://logo.clearbit.com/jpmorganchase.com', color: '#0F3D66', name: 'JPMorgan Chase' },
  BAC: { logoUrl: 'https://logo.clearbit.com/bankofamerica.com', color: '#012169', name: 'Bank of America' },
  WFC: { logoUrl: 'https://logo.clearbit.com/wellsfargo.com', color: '#D71E28', name: 'Wells Fargo' },
  GS: { logoUrl: 'https://logo.clearbit.com/goldmansachs.com', color: '#7399C6', name: 'Goldman Sachs' },
  MS: { logoUrl: 'https://logo.clearbit.com/morganstanley.com', color: '#002B5C', name: 'Morgan Stanley' },
  C: { logoUrl: 'https://logo.clearbit.com/citigroup.com', color: '#003B70', name: 'Citigroup' },
  ...
  PYPL: { logoUrl: 'https://logo.clearbit.com/paypal.com', color: '#003087', name: 'PayPal' },
  // Healthcare
  JNJ: { logoUrl: 'https://logo.clearbit.com/jnj.com', color: '#D51900', name: 'Johnson & Johnson' },
  UNH: { logoUrl: 'https://logo.clearbit.com/unitedhealthgroup.com', color: '#0063A6', name: 'UnitedHealth Group' },
  PFE: { logoUrl: 'https://logo.clearbit.com/pfizer.com', color: '#0093D0', name: 'Pfizer' },
  ABBV: { logoUrl: 'https://logo.clearbit.com/abbvie.com', color: '#071D49', name: 'AbbVie' },
  MRK: { logoUrl: 'https://logo.clearbit.com/merck.com', color: '#009DAB', name: 'Merck' },
  LLY: { logoUrl: 'https://logo.clearbit.com/lilly.com', color: '#D52B1E', name: 'Eli Lilly' },
  // Consumer
  WMT: { logoUrl: 'https://logo.clearbit.com/walmart.com', color: '#0071CE', name: 'Walmart' },
  KO: { logoUrl: 'https://logo.clearbit.com/coca-cola.com', color: '#F40009', name: 'Coca-Cola' },
  PEP: { logoUrl: 'https://logo.clearbit.com/pepsico.com', color: '#004B93', name: 'PepsiCo' },
  MCD: { logoUrl: 'https://logo.clearbit.com/mcdonalds.com', color: '#FFC72C', name: "McDonald's" },
  NKE: { logoUrl: 'https://logo.clearbit.com/nike.com', color: '#000000', name: 'Nike' },
  DIS: { logoUrl: 'https://logo.clearbit.com/disney.com', color: '#113CCF', name: 'Walt Disney' },
  // Energy
  XOM: { logoUrl: 'https://logo.clearbit.com/exxonmobil.com', color: '#ED1C24', name: 'Exxon Mobil' },
  CVX: { logoUrl: 'https://logo.clearbit.com/chevron.com', color: '#0066B2', name: 'Chevron' },
  COP: { logoUrl: 'https://logo.clearbit.com/conocophillips.com', color: '#ED1C24', name: 'ConocoPhillips' },
  // Industrial
  BA: { logoUrl: 'https://logo.clearbit.com/boeing.com', color: '#0033A0', name: 'Boeing' },
  CAT: { logoUrl: 'https://logo.clearbit.com/caterpillar.com', color: '#FFCD11', name: 'Caterpillar' },
  GE: { logoUrl: 'https://logo.clearbit.com/ge.com', color: '#3B73B9', name: 'General Electric' },
  HON: { logoUrl: 'https://logo.clearbit.com/honeywell.com', color: '#E10600', name: 'Honeywell' },
  UPS: { logoUrl: 'https://logo.clearbit.com/ups.com', color: '#351C15', name: 'UPS' },
  // Telecom
  T: { logoUrl: 'https://logo.clearbit.com/att.com', color: '#00A8E0', name: 'AT&T' },
  VZ: { logoUrl: 'https://logo.clearbit.com/verizon.com', color: '#CD040B', name: 'Verizon' },
  TMUS: { logoUrl: 'https://logo.clearbit.com/t-mobile.com', color: '#E20074', name: 'T-Mobile' },
  // Crypto Related
  COIN: { logoUrl: 'https://logo.clearbit.com/coinbase.com', color: '#0052FF', name: 'Coinbase' },
  MSTR: { logoUrl: 'https://logo.clearbit.com/microstrategy.com', color: '#C4373C', name: 'MicroStrategy' },
  MARA: { logoUrl: 'https://logo.clearbit.com/mara.com', color: '#000000', name: 'Marathon Digital' },
  RIOT: { logoUrl: 'https://logo.clearbit.com/riotplatforms.com', color: '#0033A0', name: 'Riot Platforms' },
  // BIST (Borsa Istanbul)
  ...
  SAHOL: { logoUrl: 'https://logo.clearbit.com/sabanci.com', color: '#003C71', name: 'Sabanci Holding' },
  ISCTR: { logoUrl: 'https://logo.clearbit.com/isbank.com.tr', color: '#0038A8', name: 'Is Bankasi' },
  YKBNK: { logoUrl: 'https://logo.clearbit.com/yapikredi.com.tr', color: '#004990', name: 'Yapi Kredi' },
  HALKB: { logoUrl: 'https://logo.clearbit.com/halkbank.com.tr', color: '#004B87', name: 'Halk Bankasi' },
  VAKBN: { logoUrl: 'https://logo.clearbit.com/vakifbank.com.tr', color: '#FFD100', name: 'Vakifbank' },
  TOASO: { logoUrl: 'https://logo.clearbit.com/tofas.com.tr', color: '#1B3C87', name: 'Tofas Oto' },
  TAVHL: { logoUrl: 'https://logo.clearbit.com/tavhavalimanlari.com.tr', color: '#003B73', name: 'TAV Havalimanlari' },
  TKFEN: { logoUrl: 'https://logo.clearbit.com/tekfen.com.tr', color: '#E31937', name: 'Tekfen Holding' },
  TUPRS: { logoUrl: 'https://logo.clearbit.com/tupras.com.tr', color: '#E31E24', name: 'Tupras' },
  BIMAS: { logoUrl: 'https://logo.clearbit.com/bim.com.tr', color: '#ED1C24', name: 'BIM Magazalar' },
  ASELS: { logoUrl: 'https://logo.clearbit.com/aselsan.com.tr', color: '#003366', name: 'Aselsan' },
  PGSUS: { logoUrl: 'https://logo.clearbit.com/flypgs.com', color: '#FFD700', name: 'Pegasus Airlines' },
  ENKAI: { logoUrl: 'https://logo.clearbit.com/enka.com', color: '#003399', name: 'Enka Insaat' },
  ARCLK: { logoUrl: 'https://logo.clearbit.com/arcelik.com.tr', color: '#E2001A', name: 'Arcelik' },
};
...
const FALLBACK_METAL_LOGOS: Record<string, AssetLogoInfo> = {
  ...
  IAU: { logoUrl: 'https://logo.clearbit.com/ishares.com', color: '#FFD700', name: 'iShares Gold Trust' },
  PSLV: { logoUrl: 'https://logo.clearbit.com/sprott.com', color: '#C0C0C0', name: 'Sprott Physical Silver' },
  XPTUSD: { logoUrl: '', color: '#E5E4E2', name: 'Platinum' },
  XPDUSD: { logoUrl: '', color: '#CED0DD', name: 'Palladium' },
  PPLT: { logoUrl: 'https://logo.clearbit.com/aberdeenstandard.com', color: '#E5E4E2', name: 'abrdn Platinum ETF' },
  PALL: { logoUrl: 'https://logo.clearbit.com/aberdeenstandard.com', color: '#CED0DD', name: 'abrdn Palladium ETF' },
  GDX: { logoUrl: 'https://logo.clearbit.com/vaneck.com', color: '#FFD700', name: 'VanEck Gold Miners ETF' },
  GDXJ: { logoUrl: 'https://logo.clearbit.com/vaneck.com', color: '#FFD700', name: 'VanEck Junior Gold Miners' },
  SIL: { logoUrl: 'https://logo.clearbit.com/globalxetfs.com', color: '#C0C0C0', name: 'Global X Silver Miners ETF' },
};

const FALLBACK_BOND_LOGOS: Record<string, AssetLogoInfo> = {
  TLT: { logoUrl: 'https://logo.clearbit.com/ishares.com', color: '#003087', name: 'iShares 20+ Year Treasury' },
  IEF: { logoUrl: 'https://logo.clearbit.com/ishares.com', color: '#003087', name: 'iShares 7-10 Year Treasury' },
  SHY: { logoUrl: 'https://logo.clearbit.com/ishares.com', color: '#003087', name: 'iShares 1-3 Year Treasury' },
  BND: { logoUrl: 'https://logo.clearbit.com/vanguard.com', color: '#8B2332', name: 'Vanguard Total Bond Market' },
  AGG: { logoUrl: 'https://logo.clearbit.com/ishares.com', color: '#003087', name: 'iShares Core US Aggregate' },
  LQD: { logoUrl: 'https://logo.clearbit.com/ishares.com', color: '#003087', name: 'iShares iBoxx Investment Grade' },
  HYG: { logoUrl: 'https://logo.clearbit.com/ishares.com', color: '#003087', name: 'iShares iBoxx High Yield' },
  TIP: { logoUrl: 'https://logo.clearbit.com/ishares.com', color: '#003087', name: 'iShares TIPS Bond ETF' },
  MUB: { logoUrl: 'https://logo.clearbit.com/ishares.com', color: '#003087', name: 'iShares National Muni Bond' },
  EMB: { logoUrl: 'https://logo.clearbit.com/ishares.com', color: '#003087', name: 'iShares J.P. Morgan EM Bond' },

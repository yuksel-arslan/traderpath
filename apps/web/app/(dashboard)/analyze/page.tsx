...
const ANALYSIS_STEPS = [
  ...
  { icon: BarChart3, title: 'Technical', description: 'Chart analysis', color: 'text-green-500', bg: 'bg-green-500/10' },
  { icon: Shield, title: 'Risk Check', description: 'Whale detection', color: 'text-amber-500', bg: 'bg-amber-500/10' },
  ...
  { icon: CheckCircle, title: 'Verdict', description: 'AI recommendation', color: 'text-emerald-500', bg: 'bg-emerald-500/10' },
];

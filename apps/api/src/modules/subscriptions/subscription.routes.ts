  ...
  app.get('/plans', async (_request: FastifyRequest, reply: FastifyReply) => {
    const plans = getPaidTiers().map((tier) => {
      ...
      return {
        ...
        features: {
          ...
          mlisProAccess: config.mlisProAccess,
          aiConcierge: config.aiConcierge,
    ...
    const freePlan = {
      ...
      features: {
        ...
        mlisProAccess: freeConfig.mlisProAccess,
        aiConcierge: freeConfig.aiConcierge,
        apiAccess: freeConfig.apiAccess,
        prioritySupport: freeConfig.prioritySupport,
        earlyFeatures: freeConfig.earlyFeatures,
      },
      limits: {
        ...
        return reply.send({
          ...
          data: {
            ...
            features: {
              ...
              mlisProAccess: subscription.config.mlisProAccess,
              aiConcierge: subscription.config.aiConcierge,
              apiAccess: subscription.config.apiAccess,
              prioritySupport: subscription.config.prioritySupport,
              earlyFeatures: subscription.config.earlyFeatures,
            },
            limits: {

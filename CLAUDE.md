...
| 2026-02-26 | AnimatedCounter bileşeni oluşturuldu (`components/ui/AnimatedCounter.tsx`). IntersectionObserver + requestAnimationFrame + easeOutCubic ile viewport'a girince 0'dan hedef değere smooth animasyon. Landing page Stats bölümüne entegre edildi — API'den gelen gerçek metrikler animasyonlu gösteriliyor. |

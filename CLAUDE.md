...
| 2026-02-05 | Trade plan entry/SL/TP seviyeleri güncel fiyattan çok uzaktaydı (örn: fiyat $112 iken entry $178) | `findSupportResistance()` günlük mumlardan aylar öncesine ait (ATH bölgesi) destek/direnç seviyeleri tespit ediyordu ve bunlar filtrelenmeden trade plan'da kullanılıyordu. 1) `levelWithinRange()` fonksiyonu eklendi - güncel fiyattan >%10 uzaktaki seviyeler filtreleniyor, 2) Entry, SL ve TP hesaplamalarında tüm seviyeler filtrelenmiş versiyonları kullanıyor, 3) averageEntry için son güvenlik kontrolü eklendi - %10 aşarsa current price'a sıfırlanıyor | `analysis.engine.ts:5371-5378,5530-5548` |

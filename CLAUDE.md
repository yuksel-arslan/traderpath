...
| 2026-02-02 | Mind map'te layer'ların expanded içeriğinden fullscreen modal'a geçiş yoktu | `SystemFlowChart` komponentine `onLayerClick` callback prop eklendi. Her layer'ın expanded içeriğine "View Full Details" butonu eklendi (Layer 1: teal, Layer 2: cyan, Layer 3: purple, Layer 4: amber gradient). Butonlara tıklandığında fullscreen modal açılıyor. Ana sayfada `setFullscreenLayer` callback olarak geçiriliyor | `capital-flow/page.tsx` |
